...
```{r regressions, results= 'asis', message=F, error=F, warning=F}
...
## Auxiliary Regression without upload variables

```{r regressions no upload and test, results= 'asis', message=F, error=F, warning=F}
# helpful sources: http://www.princeton.edu/~otorres/LogitR101.pdf
# https://thestatsgeek.com/2014/02/08/r-squared-in-logistic-regression/
