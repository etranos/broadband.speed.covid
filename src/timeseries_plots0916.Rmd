...
ggplot(subset(ts.down,date > start.date), aes(x=as.POSIXct(date), y=mean.down, group = LAD19NM, colour = "red")) +
  ...
  geom_line(data = subset(mean.down.uk,date > start.date), aes(x=as.POSIXct(date), y=mean.down.uk, group = 1), colour="green") #
...
ggplot(subset(ts.up,date > start.date), aes(x=as.POSIXct(date), y=mean.up, group = LAD19NM, colour = "red")) +
  ...
  theme(axis.text.x = element_text(angle = 45, hjust = 1), axis.title.x = element_blank(),
        plot.title = element_text(hjust = 0.5)) +
  facet_wrap(~LAD19NM, ncol = 2) +
  geom_line(data = subset(mean.up.uk,date > start.date), aes(x=as.POSIXct(date), y=mean.up.uk, group = 1), colour="green") #
...
ggplot(subset(ts.tests,date > start.date), aes(x=as.POSIXct(date), y=n.tests, group = LAD19NM, colour = "red")) +
  ...
  geom_line(data = subset(mean.tests.uk,date > start.date), aes(x=as.POSIXct(date), y=mean.tests.uk, group = 1), colour="green") #.uk
...
ts.down.diff$date.lag1y <- ts.down.diff$date - years(1)
ts.down.diff <- merge(ts.down.diff,ts.down.diff, by.x = c("date.lag1y", "LAD19NM"), by.y = c("date","LAD19NM"), all = F)
...
ggplot(subset(ts.down.diff,date > start.date), aes(x=as.POSIXct(date), y=diff, group = LAD19NM, colour = "red")) +
...
ts.up.diff <- ts.up
ts.up.diff$date.lag1y <- ts.up.diff$date - years(1)
ts.up.diff <- merge(ts.up.diff,ts.up.diff, by.x = c("date.lag1y", "LAD19NM"), by.y = c("date","LAD19NM"), all = F)
...
ggplot(subset(ts.up.diff,date > start.date), aes(x=as.POSIXct(date), y=diff, group = LAD19NM, colour = "red")) +
  ...
  theme(axis.text.x = element_text(angle = 45, hjust = 1), axis.title.x = element_blank(),
        plot.title = element_text(hjust = 0.5)) +
  facet_wrap(~LAD19NM, ncol = 2) +
  geom_line(data = subset(mean.up.diff.uk,date > start.date), aes(x=as.POSIXct(date), y=mean.up.diff.uk, group = 1), colour="green") #
```
...
ts.tests.diff$date.lag1y <- ts.tests.diff$date - years(1)
ts.tests.diff <- merge(ts.tests.diff,ts.tests.diff, by.x = c("date.lag1y", "LAD19NM"), by.y = c("date","LAD19NM"), all = F)
...
ggplot(subset(ts.tests.diff,date > start.date), aes(x=as.POSIXct(date), y=diff, group = LAD19NM, colour = "red")) +
  ...
  theme(axis.text.x = element_text(angle = 45, hjust = 1), axis.title.x = element_blank(),
        plot.title = element_text(hjust = 0.5)) +
  facet_wrap(~LAD19NM, ncol = 2) +
  geom_line(data = subset(mean.tests.diff.uk,date > start.date), aes(x=as.POSIXct(date), y=mean.tests.diff.uk, group = 1), colour="green") #
```