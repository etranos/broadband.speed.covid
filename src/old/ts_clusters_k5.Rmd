---
title: "Time series clusters, k = 5"
...
# save clusters file
out.clusters <- paste(path, "/data/temp/clusters_all_5.csv", sep = "")
...
# save clusters file
out.clusters <- paste(path, "/data/temp/clusters_nodiff_5.csv", sep = "")
...
# out.path.map <- paste0(path, "/paper/v1/figures/map.up.clusters5.png")
# ggsave(out.path.map)#,
#width = 210, #A4
#height = 297, #A4
#units = "mm")
