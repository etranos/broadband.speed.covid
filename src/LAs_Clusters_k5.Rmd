...
path.cluster <- paste(path, "/data/temp/clusters_nodiff_5.csv", sep = "")
...
# data.out.path <- paste0(path, "/data/temp/data_for_aux_k5.csv")
...
```{r}
path.out <- paste0(path, "/data/temp/LAs_Clusters_k5.RData")
save.image(path.out)
```