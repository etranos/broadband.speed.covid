...
leaflet(la) %>%
  ...
  #addLegend(values = 1, group = "cluster.up", position = "bottomleft", colors= ~factpal.up(cluster.up)) #%>% 
  #addLegend(values = 2, group = "cluster.down", position = "bottomleft", labels = "2" ,colors= "blue")
