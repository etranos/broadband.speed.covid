...
the existing economic and digital geography of the UK. **need to add in urban-rural**
...
of workers. 
Instead, in the UK, for example, benchmarking broadband performance and service 
delivery by different Internet Service Providers (ISPs) focused upon the quality of 
service for evening leisure use, when video streaming services are at their peak, 
rather than during the working day [@ofcom2017].
...
home will be much higher than the pre-Covid, raising questions around whether 
internet services can accommodate the increased demand.
...
Furthermore, a recent estimate indicated that $37$% of all jobs in the US can be
...
The third level focuses on the differentiated returns of internet use **for...?**
...
assumes skills that are present in some occupations but not in others, 
...
framework for understanding which types of places, socially and spatially, 
...
UK during a time of extreme demand, we will better understand which places benefit 
from greater economic resilience not only during the pandemic, but also into the 
future.
...
telecommuting within different workforces, distinguising, for example, between those 
directly employed, indirectly employed, self-employed, full-time or part-time, and 
who use digital technologies to work remotely full-days or part-days 
[@allen2015effective; @bailey2002review; @haddad2009examination].
<!--old text: An appropriate definition of teleworking is ‘the remote provision of labour that would otherwise be carried out within company premises’ (European Commission, 2020b).-->
...
home, and that occupations with opportunities to telecommute are associated
...
These returns have been even greater during the Covid-19 crisis, when those with the 
ability to telecommute also have the ability to maintain their employment whilst 
protecting their health.
However, the success of these arrangements has also been dependent upon the first 
...
reduction in household transport spend across 33 coutries, although the authors are 
uncertain whether this implies less travel, for example because of increased
telecommuting, or whether internet access enables more efficient travel 
[@bris2017ict].
However, the extreme demand during the pandemic provides a new opportunity to 
understand how infrastructure accessibility, quality, and reliability affects 
telecommuting, particularly as working from home during the pandemic required
...
Thus by answering questions about internet service resilience, we can also refine our
understanding of how this has contributed to or reduced the new digital divide where
economic resilience has been dependent upon the capability to work from home.
...
as possible. 
We start by calculating the mean upload speed for every local government district in 
the UK for each hour of each weekday, excluding midnight to 6:00, weekends and bank 
holidays. 
We then cluster the local authorities by these temporal profiles, allowing us to 
identify patterns and describe the overall means, standard deviations, and other 
relevant statistics for each spatial cluster. 
...
different areas, as they may reflect similarities in patterns of demand or similar 
...
**HANNAH, HOW DOES THIS SOUND - this last bit probably in the discussion at the end?**
