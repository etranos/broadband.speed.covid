...
Upload speeds are less associated with internet-based leisure activities such
as video streaming, which involve downloading large amounts of data, but they
...
experienced internet service and resilience.
Although we know from government statements the start and end of the period of
interest, namely, March to May 2020, the frequency of speed tests within that period 
provides an indication of the volume of experience over any particular units of time.

<!-- data transformation -->
Thus, the first step in the workflow after dropping some outliers following
...
by not only the day of the week, but also time of day, as can be seen in **[graph]**.
Thus, a daily aggregation of upload speeds would also mask this pattern.
Furthermore, the importance of this pattern is highlighted by a comparison 
with the same period in 2019 **see graph**, 
...
work purposes, bank holidays and the hours between midnight and 6am were excluded,
