...
path.out = paste0(path, "/paper/v2_taylor_francis_for_proof/tables/table_1.txt")
...
path.out = paste0(path, "/paper/v2_taylor_francis_for_proof/tables/table_2.txt")
...
path.out = paste0(path, "/paper/v2_taylor_francis_for_proof/tables/table_A1.txt")
